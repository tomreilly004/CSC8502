...
void OGLRenderer::SetShaderSpotlight(const Spotlight& l) {
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "spotPos"),1, (float*)&l.GetPosition());

	glUniform4fv(glGetUniformLocation(currentShader->GetProgram(), "spotColour"),1, (float*)&l.GetColour());

	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "spotRadius"), l.GetRadius());

	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "spotDirection"), 1, (float*)&l.GetDirection());

	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "spotAngle"), l.GetAngle());
}
